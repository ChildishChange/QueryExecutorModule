...
object Const {
    ...
    /**
      * If the legacy cache is enabled.
      */
    var cacheEnableLegacy: Boolean = false

    /**
      * If the application is running at server mode.
      */
    var serverMode: Boolean = false

    /**
      * Root dir for input RDF file.
      */
    var rootDir: String = null;

    /**
      * If enable all optimizations.
      */
