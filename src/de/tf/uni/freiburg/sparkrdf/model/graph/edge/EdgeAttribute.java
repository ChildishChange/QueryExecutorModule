...
/**
 * Class that represents the edges of the graph. An edge could be a plain String which is the case,
 * if the edge attribute only occurs as predicate in the RDF graph. If the edge attribute also
 * exists as subject or object, than the Id of this node is also stored inside this object.
 *
...
public class EdgeAttribute implements Serializable {
     ...
     * @param edgeAttribute Attribute of the edge
     */
