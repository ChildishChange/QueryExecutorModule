...
public class VertexAttribute implements VertexInterface {
    ...
    /**
     * Removes all results that are from nodes which are contained in the toDelete map
     *
    ...
    /**
     * Remove all {@link ResultValue}s from the given set with the according attribute
     *
