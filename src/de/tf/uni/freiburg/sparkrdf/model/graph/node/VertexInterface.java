...
/**
 * Interface for all nodes in the graph, which is introduced that the graph can be joined with other
 * types
 *
...
public interface VertexInterface extends Serializable {
     ...
     *
     * @param childMatches Matching results
     */
     ...
     *
     * @return true iff this node matches at least one part of the basic graph pattern
     */
     ...
     *
     * @param parentMatches Matching results
     */
    ...
    /**
     * Transform the normal results into result which contain the node attribute that they can be
     * sent to the neighbors
     *
     * @param id  Id of the node where the results should be sent
     ...
     *
     * @param bgp   All {@link TriplePattern} that should be used to verify the results
     * @param local True if only things should be verified where no child or parent results are
     *              needed
    ...
    /**
     * Updates the matching results for the given NodeTest. Old results are removed and all new
     * added.
     *
     * @param updatedChildMatches New matches for the given node
     */
     ...
     *
     * @param New Results or null if the results are empty
     */
     ...
     * added.
     *
     * @param updatedParentMatches New matches for the given node
     */
     ...
     * @param attribute Attribute of the child
     */
    public void addChildNode(Long id, String attribute);

    /**
     * Removes all results of a node from the child and parent match sets and also deletes them from
     * the parents and children
     *
     * @param nodeAttr Attribute to remove
     */
