...
/**
 * Class that extends the {@link CompositeKey} to also store the attribute of a node. This class is
 * used to send the values of a node to his parent and child nodes.
 *
