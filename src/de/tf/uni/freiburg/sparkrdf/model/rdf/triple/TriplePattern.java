...
public class TriplePattern implements Serializable {
    ...
    /**
     * Checks a part of a triplet against the according part of the Sparql triple
     *
    ...
    /**
     * Check if the subject or object of this triple pattern is equal to the predicate. If yes then
     * check that the given node equals the given predicate
     *
    ...
    /**
     * Check if the subject and object of this triple are equal. If yes then the two given nodes
     * should be equal too.
     *
