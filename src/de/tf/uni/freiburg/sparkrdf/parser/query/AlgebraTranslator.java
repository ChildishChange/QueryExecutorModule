...
import de.tf.uni.freiburg.sparkrdf.parser.query.op.SparkJoin;
...
public class AlgebraTranslator extends OpVisitorBase {
    ...
    public boolean isJoinIdentity(Op op) {
    ...
    public void visit(OpJoin opJoin) {
        ...
        if (isJoinIdentity(left)) {
            ...
            if (isJoinIdentity(right)) {
                ...
                executionQueue.add(new SparkJoin(opJoin));
            }
        }
    }
    ...
    /**
     * Put an expression into an Basic Graph Pattern if it can be executed directly
     *
