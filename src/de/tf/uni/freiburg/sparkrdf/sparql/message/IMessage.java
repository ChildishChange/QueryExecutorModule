...
public interface IMessage extends Serializable {
    ...
    /**
     * Get the results for the node. Only applicable for {@link UpdateMessage} and {@link
     * NodeResultMessage}.
     *
    ...
    /**
     * Add results to this message, works only once. If you call it twice then the last results will
     * be taken
     *
