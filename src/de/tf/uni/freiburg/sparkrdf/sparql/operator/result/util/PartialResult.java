...
/**
 * Represents a part of the result. This means that the sum of all {@link TriplePattern}s contained
 * in all {@link PartialResult}s make up the whole result. A clustering in more than one partial
 * results happen for example with this basic graph pattern:
 *
 * ?a knows ?b, ?y knows ?z
 *
...
public class PartialResult {
     ...
     *
     * @param tp First {@link TriplePattern}
     */
     ...
     *
     * @param tps Set of {@link TriplePattern}
     */
     ...
     *
     * @param tps New {@link TriplePattern}
     */
